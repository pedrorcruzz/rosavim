...
function M.get(mode, transparent_background)
  if mode == 'light' then
    return {
      ...
      ['@markup.heading.1.markdown'] = { fg = '#383A42' },
      ['@punctuation.bracket'] = { fg = '#383A42' },

      BufferLineModified = { fg = '#707070' },
      BufferLineModifiedVisible = { fg = '#707070' },
      BufferLineModifiedSelected = { fg = '#707070' },
      BufferLineBufferSelected = { fg = '#383A42' },
      BufferLineBackground = { fg = '#909090' },
      BufferLineSeparator = { fg = '#D0D0D0' },
      BufferLineIndicatorSelected = { fg = '#FAFAFA' },
