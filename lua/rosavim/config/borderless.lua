...
--- borders the same colour as their own bg so they blend in, in every rosa
--- theme. Called from the ColorScheme autocmd (plugins/ui/colorscheme.lua)
...
function M.apply()
  ...
  for _, group in ipairs { 'WhichKeyBorder', 'SnacksPickerBorder' } do
